<html>
  ...
  <br><a href="https://www.facebook.com/hosin.damlakhi"><%=name%></a></br>
      <a target="_blank" herf="art/<%=pic_id%>.jpg" margin="auto" height="300px"></a>
      <img src="art/<%=pic_id%>.jpg" alt="" width="400px">
    </a>

<h2>enter your comment</h2>
<form action="myphoto.asp?id=<%=id%>&text=<%=name%>" method="post">
